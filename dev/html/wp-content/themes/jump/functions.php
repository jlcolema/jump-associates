 ...
 */
	...
	function bloom_setup() {
		...
		// Original size is 500 x 500

		// add_image_size( 'bio_hero_large', xxx, xxx, true );

		add_image_size( 'bio_hero_medium', 260, 260, true );

		// add_image_size( 'bio_hero_small', xxx, xxx, true );


		/* Hero */

		// Original size is 1100 x 850

		// add_image_size( 'hero_large', xxx, xxx, true );

		add_image_size( 'hero_medium', 550, 425, true );

		// add_iamge_size( 'hero_small', xxx, xxx, true );


		/* Mission Statement Image (on home page) */

		// Original size is 530 x 380

		// add_image_size( 'mission_statement_image_large', xxx, xxx, true );

		add_image_size( 'mission_statement_image_medium', 265, 190, true );

		// add_iamge_size( 'mission_statement_image_small', xxx, xxx, true );
	...
	if(function_exists('acf_add_options_page')) {
		...
		acf_add_options_sub_page(array(
			...
			'page_title' 	=> 'Business Inquiries',
			'menu_title'	=> 'Business Inquiries',
			'parent_slug'	=> 'globals'
		...
		acf_add_options_sub_page(array(
			...
			'page_title' 	=> 'Press Inquiries',
			'menu_title'	=> 'Press Inquiries',
			'parent_slug'	=> 'globals'
